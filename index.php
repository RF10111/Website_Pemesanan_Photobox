...
<body>
  <!-- Navbar start -->
  <nav class="navbar">
    <a href="#" class="navbar-logo">your<span>5oul</span></a>
  ...
  <section class="hero" id="home">
    <main class="content">
      ...
      <a href="signup.php" class="cta">Register Now!</a>
    </main>
  </section>
  <!-- Hero Section end -->
  ...
  <section id="contact" class="contact">
    ...
    <div class="row">
      ...
      <form action="funct.php" method="POST">
        ...
        <button type="submit" name="send"style="margin-top: 1rem;font-weight: bolder;  display: inline-block;  padding: 1rem 3rem;  font-size: 1.4rem;  color: #000000;  background-color: var(--primary);  border-radius: 0.5rem;  box-shadow: 1px 1px 3px rgba(144, 175, 197, 0.5);">
        Send Message</button>
      </form>
    </div>
  </section>
